...
- [Understanding and Using C Pointers](https://annas-archive.gl/md5/2b4bb6097335799919742f79b5356708) — A great book to help with building libft and understanding pointers in C

### AI usage

- **Debugging `Search`** — Use IA to search and debugging
- **Code `Code review`** — Use IA to review my code